...
def load_data():
    ...
    data = {
        ...
        'TI': [0.0, 0.33, 0.25, 1.25, 1.74, 1.61, 2.08, 3.55, 3.16, 0.16, 0.33, 0.29,
               0.63, 0.96, 0.87, 1.09, 1.00, 1.03, 0.93, 0.85, 0.75, 0.31, 0.31, 0.35,
               0.16, 0.06, 0.08, 0.0, 0.06, 0.05, 0.0, 0.28, 0.21],
        'IC95_min': [0.0, 0.12, 0.00, 0.54, 1.18, 1.14, 1.11, 2.71, 2.47, 0.0, 0.12, 0.12,
                     0.17, 0.56, 0.54, 0.44, 0.6, 0.57, 0.35, 0.35, 0.45, 0.04, 0.01, 0.04,
                     0.0, 0.0, 0.01, 0.0, 0.0, 0.00, 0.0, 0.9, 0.07],
        'IC95_max': [0.57, 0.73, 0.54, 2.46, 2.47, 2.2, 3.55, 4.58, 3.97, 0.87, 0.73, 0.59,
                     ...
                     0.87, 0.31, 0.30, 0.57, 0.31, 0.23, 0.57, 0.65, 0.48]
    }
